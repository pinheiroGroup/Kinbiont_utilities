...
function CMR_GLU_dynamics(du, u, param, t)
    ...
    du[1] = - VA0_GL * B_1  * lag_factor # dG_L_dt glucose on the left

    du[2] = lag_factor * mu_max_1 *( VA0_GL )* B_1   # dB_L_dt # biomass in the left A0
...
u0 = [0.0055,mean(data_to_fit[2,1:3])]  # Initial conditions NOTE THE DOUBLE OF THE INITIAL GLUCOSE
param = [0.001, 0.1,10.0]  #  
ub_p = [500.5, 300000.0,96.0]
lb_p = [0.0, 0.0,0.0]
...
function CoC_dynamics(du, u, param, t)
    B_1, B_2,G = u
   mu_1,mu_2, interaction_1_2, interaction_2_1,lag_1,lag_2 = param
...
param = [0.1,0.1,0.1, 0.1,0.0001,0.0001]  #  K_A0_G, K_LP_G, K_A0_S1, K_LP_S2,leak_1,leak_2, mu_max_1,mu_max_22 
ub_p = [1000.0,1000.0,100.0, 100.0,100,100]
lb_p = [000.0,00.0,-100.0, -100.0,0.0,0.0]
