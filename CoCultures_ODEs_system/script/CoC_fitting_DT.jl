...
Plots.plot!(results_ODE_fit[4],results_ODE_fit[3], xlabel="Time [h]", ylabel="OD [Arb. Units]",label=["fit AO" nothing],color=:grey,markersize =4 ,size = (400,400),linewidth=4)
...
Plots.plot!(results_ODE_fit[4],results_ODE_fit[3], xlabel="Time [h]", ylabel="OD [Arb. Units]",label=["fit AO+LP" nothing],color=:green,markersize =4 ,size = (400,400),linewidth=4,linestyle=:dash)
results_matrix = [results_matrix results_ODE_fit[2]]
...
Plots.plot!(results_ODE_fit[4],results_ODE_fit[3], xlabel="Time [h]", ylabel="OD [Arb. Units]",label=["fit AO+LB" nothing],color=:red,markersize =4 ,size = (400,400),linewidth=4,linestyle=:dot)
...
Plots.plot!(results_ODE_fit[4],results_ODE_fit[3], xlabel="Time [h]", ylabel="OD [Arb. Units]",label=["fit AO+AO" nothing],color=:blue,markersize =4 ,size = (600,500),legendposition = :topleft,linewidth=4,linestyle=:dashdot,tickfontsize = 20,labelfontsize = 20,legendfontsize =11)
savefig("../CoC_fitting_dt.svg")
...
savefig("../CoCultures_ODEs_system/DT_GR_CoC.svg")
...
wt = DecisionTree.wrap(dt[1])
p2 = Plots.plot(wt, 0.9, 0.2; size=(1400, 700), connect_labels=["yes", "no"])
savefig("../CoCultures_ODEs_system/DT_Nmax_CoC.svg")
